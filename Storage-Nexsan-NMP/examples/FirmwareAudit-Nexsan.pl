...
# script that runs an firmware check of a nexsan
...
say "Status: $NexsanInfo{status}  model: $NexsanInfo{model} firmware: $NexsanInfo{firmware} friendlyname $NexsanInfo{friendlyname}"; 
...
FirmwareAudit-Nexsan - script to get usefull data from a Nexsan storage unit via thier NMP.
